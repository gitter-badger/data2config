...
manager.EffectArrayStaticVo_Data = require(CURRENT_PACKAGE..".EffectArrayStaticVo_Data")
function manager.getEffectArrayStaticVo(idx)
    return manager.EffectArrayStaticVo_Data[idx]
end
...
function manager.getRandomNameVo(type)
    return manager.RandomNameVo_Data[tostring(type)]
end
...
_G.package[CURRENT_PACKAGE..".EffectArrayStaticVo_Data"]=nil
